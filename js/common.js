$(document).ready(function(){
  ...
  $('.-header_menu-toggler').click(function(){
    if ($('.header_mobil_nav').hasClass("active")){
      $('.header_mobil_nav').removeClass("active").slideUp();
    } else{
      $('.header_mobil_nav ').addClass("active").slideDown();
    }
    return false;
  });
  $('.header_mobil_line .close').click(function(){
      $('.header_mobil_nav').removeClass("active");
      return false;
  });
  $('.section_lk_navbar_toggle').click(function(){
    $('.lk_menu').slideToggle();
  });
  $('.mobil_row').click(function(){
    $(this).parents('.person_info_wrap ').find('.-mhide').slideToggle();
  });
